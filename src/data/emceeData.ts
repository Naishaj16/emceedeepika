...
export const GALLERY: GalleryItem[] = [
  {
    id: 'g1',
    title: 'Superwomen Live Summit Hosting — Mumbai Convention Centre',
    category: 'corporate',
  ...
  {
    id: 'g2',
    title: 'Luxury Destination Sangeet & Royal Entry — Taj Lake Palace',
    category: 'wedding',
    image: '/images/deepika/deepika-5.webp',
    location: 'Udaipur, Rajasthan',
    year: '2024',
  ...
  {
    id: 'g3',
    title: 'International Corporate Leadership Gala — Dubai World Trade Centre',
    category: 'celebrity',
  ...
  {
    id: 'g4',
    title: 'Pan-Asia Summit Multilingual Keynote Host — Singapore Hub',
  ...
  {
    id: 'g5',
    title: 'Live Corporate Gala & VIP Speaker Moderation — Delhi NCR Summit',
    category: 'corporate',
  ...
  {
    id: 'g6',
    title: 'Corporate Excellence & Industry Recognition Night — Chennai Expo',
    category: 'corporate',
    image: '/images/deepika/deepika-6.webp',
